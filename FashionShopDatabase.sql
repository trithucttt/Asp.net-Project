...
insert into Users values ('Nguyen','Dang Khoa','0914932098','ndangkhoa567@gmail.com','khoavirgo','81dc9bdb52d04dc20036dbd8313ed055','1','30/4','Ninh Kieu','Can Tho','Viet Nam')
...
--Product_Shirt--
insert into Products values(3,N'Áo khoác lá cổ đơn giản',N'Khoác thoải mái phù hợp cho những chuyến du lịch khám phá. Phối với nhiều Items để tạo những set trang phục ấn tượng','500000','Adidas','Có sẵn');
insert into Products values(3,N'Sơ mi tay dài',N'Form dáng áo cổ điển được thiết kế vừa vặn, phù hợp với mọi đối tượng. Đặc biệt độ dài phù hợp với mọi sở thích: sơ-vin hoặc thả áo đều được','300000','YaMe','Có sẵn');
insert into Products values(3,N'Áo thun cổ trụ đơn giản',N'Áo được thiết kế vừa vặn thoải mái. Phần eo, nách và tay áo được thiết kế vừa phải, tự do vận động','270000','Pico','Có sẵn');
insert into Products values(3,N'Áo Thun Polo Nữ Kiểu Croptop Ngắn Tay WTS 2237',N'Áo Thun Polo Nữ Kiểu Croptop Ngắn Tay WTS 2237. Áo thun polo crotop với độ dài vừa phải, không hở nhiều. Form áo ôm người gọn gàng, tôn dáng.','320000','CoupleTX','Có sẵn');
...
insert into Products values(3,N'Áo Polo Nam Relax Fit In Typo',N'Áo Polo Nam Relax Fit In Typo Serial Chiller MPO 1015 Mẫu áo polo mang hơi hướng hiện đại, trẻ trung nhờ sở hữu form dáng relax năng động. Điểm nhắn là phần hình in ở mặt sau và logo được nổi bật hơn nhờ phần dạ xanh.','429000','Pico','Có sẵn');
...
insert into Products values(3,N'Áo Khoác Dù Nữ Phát Quang',N'Áo Khoác Dù Nữ Phát Quang WOP 2031. Là sản phẩm áo khoác có khả năng phát sáng trong đêm. Phát sáng trong bóng tối khi tiếp xúc với ánh sáng tự nhiên hoặc nhân tạo trước đó ít nhất 5 phút.','990000','coupleTX','Có sẵn');
insert into Products values(3,N'Áo Polo Nữ Pique Regular Fit',N'Áo Polo Nữ Pique Regular Fit Phối Trụ Bo Kiểu WPO 2023. Áo polo có bo và trụ dệt cách điệu vừa thời trang, vừa độc đáo. Form regular gọn gàng, không quá ôm người.','359000','Yody','Có sẵn');
insert into Products values(3,N'Áo Kiểu Nữ Sơ Mi Xẻ Tà Thân Sau',N'Áo Kiểu Nữ Sơ Mi Xẻ Tà Thân Sau WBL 2017. Áo sơ mi kiểu nữ với điểm nhấn ở sườn áo và thân sau xẻ tà, tạo phong cách vừa phóng khoáng, vừa nữ tính và thời trang.','449000','Yody','Có sẵn');
...
insert into Products values(4,N'Áo Len Gân Nữ Tay Dài Cổ Tim',N'Áo len nữ dệt gân dáng ôm với phần cổ tim nữ tính, kiểu dệt gân tạo cảm giác thoải mái, co giãn tốt, chiếc áo với chất liệu len siêu mềm mướt, giữ ấm và thấm hút tốt.','399000','Yody','Có sẵn');
insert into Products values(4,N'Đầm Đông Nữ Kẻ Tay Phối',N'Thiết kế đầm kẻ tay phối thanh lịch và đầy nữ tính, kiểu dáng ấn tượng giúp tôn lên đường cong cơ thể cho người mặc, chất liệu dày dặn vừa phải, thích hợp mặc ngay cả trong mùa thu đông','669000','Yody','Có sẵn');
insert into Products values(4,N'Bộ Đồ Thể Thao Trẻ Em Youth Life',N'Chất liệu  91% Polyester + 9% Spandex, vải được dệt từ sợi Polyester dài & mảnh, kết hợp cùng kiểu dệt Double Face cho nền vải chắc chắn nhưng vẫn có độ xốp, nhẹ nhàng, độ bền cao, ít nhăn','599000','Yody','Có sẵn');
insert into Products values(4,N'TÚI VUÔNG MINI NHIỀU NGĂN',N'Túi city vải cỡ mini, đính đá lấp lánh. Có hai quai xách tay buộc thắt nút ở hai đầu. Bên trong lót vải. Có một dây đeo dạng xích bằng kim loại, dùng để đeo chéo. Đóng mở bằng khuy nam châm.','1999000','Zara','Có sẵn');
...
insert into Products values(4,N'Áo Khoác Classic Tối Giản Ver6',N'Áo Khoác Classic Đơn Giản Y Nguyên Bản Ver6, chất liệu: Vải Dù, thành phần: 100% poly, chống tia UV, cản gió, nhanh khô, bền màu tốt, trượt nước','385000','Yame','Có sẵn');

--Quần nè--
insert into Products values(4,N'Quần Jean Nam S-Cafe Thân Thiện Với Môi Trường',N'Quần jeans nam chất liệu cotton USA - loại vải cao cấp được cả thế giới tin dùng với nhiều ưu điểm nổi bật, cotton USA sạch hơn các loại bông khác do quá trình thu hoạch sử dụng thiết bị điều khiển bằng máy tính tân tiến nhất','599000','Yody','Có sẵn')
insert into Products values(4,N'Quần Âu Nam Classic Thêu Yody',N'Chất liệu: 78% polyester+ 18% rayon+ 4% spandex thoáng khí, thấm hút tốt','549000','Yody','Có sẵn')
insert into Products values(4,N'Quần Short Nam Yody Sport',N'Chất liệu mềm mại, nhẹ nhàng phù hợp vận động, thiết kế thể thao, khỏe khoắn. Cạp chun cả vòng bản to vô cùng khỏe khoắn','199000','Yody','Có sẵn')
insert into Products values(4,N'Quần Kaki Nam Regular',N'Quần kaki nam dáng regular thoải mái, tôn dáng, thiết kế basic, màu sắc hiện đại, dễ phối đồ','499000','Yody','Có sẵn')
insert into Products values(4,N'Quần Legging Nữ 2 Túi Khóa',N'Chất liệu 70% Viscose, 25% Polyesster, 5% spandex, thoải mái cùng chất liệu mềm mại, dày dặn','349000','Yody','Có sẵn')
insert into Products values(4,N'Quần Dài Vải Linh Vật Olygre Ver3',N'Quần ống rộng hay culottes là định nghĩa cho loại quần dài có ống rộng, dáng suông và có độ dài qua đầu gối. Quần ống rộng thực chất được thiết kế dành cho nam giới. Tuy nhiên những năm 1902, những chiếc quần này được phái nữ bắt đầu sử dụng với cái tên khác là quần Thổ Nhĩ Kỳ.','425000','Yame','Có sẵn')
insert into Products values(4,N'Quần Dài Vải Đơn Giản Y Nguyên Bản Ver14',N'Quần trouser là một kiểu dáng quần nam cổ điển được nhiều quý ông yêu thích. Đây là một loại quần âu (Quần tây) dáng dài chuyên phục vụ cho quý ông công sở.','397000','Yame','Có sẵn')
insert into Products values(4,N'Quần Tây Nam Pierre Cardin - PQT000288',N'Quần tây nam chất lượng cao đến từ thương hiệu Pierre Cardin','1750000','Pierre Cardin','Có sẵn')
insert into Products values(4,N'Quần Golf Nam An Phước - AQTG00618',N'Lựa chọn quần áo đánh golf nam phù hợp với hoàn cảnh ra sân. Khi tham gia những trận cầu giải trí, nghiệp dư hoặc các giải đấu nhỏ.','950000','An Phuoc','Có sẵn')
...
insert into Image values ('../../Content/images/products/pd32.5.jpg')
insert into Image values ('../../Content/images/products/pd32.6.jpg')
...
insert into Image values ('../../Content/images/products/pd33.5.jpg')
insert into Image values ('../../Content/images/products/pd33.6.jpg')
...
insert into Image values ('../../Content/images/products/pd34.5.jpg')
insert into Image values ('../../Content/images/products/pd34.6.jpg')
...
insert into Image values ('../../Content/images/products/pd35.5.jpg')
insert into Image values ('../../Content/images/products/pd35.6.jpg')
...
insert into Image values ('../../Content/images/products/pd36.5.jpg')
insert into Image values ('../../Content/images/products/pd36.6.jpg')
insert into Image values ('../../Content/images/products/pd36.7.jpg')
...
insert into Image values ('../../Content/images/products/pd37.5.jpg')
insert into Image values ('../../Content/images/products/pd37.6.jpg')
insert into Image values ('../../Content/images/products/pd37.7.jpg')
...
insert into Image values ('../../Content/images/products/pd38.5.jpg')
insert into Image values ('../../Content/images/products/pd38.6.jpg')
insert into Image values ('../../Content/images/products/pd38.7.jpg')
...
insert into Image values ('../../Content/images/products/pd39.5.jpg')
insert into Image values ('../../Content/images/products/pd39.6.jpg')
...
insert into Image values ('../../Content/images/products/pd40.5.jpg')
...
insert into Image values ('../../Content/images/products/pd42.5.jpg')
...
insert into Image values ('../../Content/images/products/pd45.5.jpg')
insert into Image values ('../../Content/images/products/pd45.6.jpg')
...
insert into Image values ('../../Content/images/products/pd46.5.jpg')
...
insert into Image values ('../../Content/images/products/pd48.5.jpg')
...
insert into Product_Image values (32, 129)
insert into Product_Image values (32, 130)
insert into Product_Image values (32, 131)
insert into Product_Image values (33, 132)
insert into Product_Image values (33, 133)
insert into Product_Image values (33, 134)
insert into Product_Image values (33, 135)
insert into Product_Image values (33, 136)
insert into Product_Image values (33, 137)
insert into Product_Image values (34, 138)
insert into Product_Image values (34, 139)
insert into Product_Image values (34, 140)
insert into Product_Image values (34, 141)
insert into Product_Image values (34, 142)
insert into Product_Image values (34, 143)
insert into Product_Image values (35, 144)
insert into Product_Image values (35, 145)
insert into Product_Image values (35, 146)
insert into Product_Image values (35, 147)
insert into Product_Image values (35, 148)
insert into Product_Image values (35, 149)
insert into Product_Image values (36, 150)
insert into Product_Image values (36, 151)
insert into Product_Image values (36, 152)
insert into Product_Image values (36, 153)
insert into Product_Image values (36, 154)
insert into Product_Image values (36, 155)
insert into Product_Image values (36, 156)
insert into Product_Image values (37, 157)
insert into Product_Image values (37, 158)
insert into Product_Image values (37, 159)
insert into Product_Image values (37, 160)
insert into Product_Image values (37, 161)
insert into Product_Image values (37, 162)
insert into Product_Image values (37, 163)
insert into Product_Image values (38, 164)
insert into Product_Image values (38, 165)
insert into Product_Image values (38, 166)
insert into Product_Image values (38, 167)
insert into Product_Image values (38, 168)
insert into Product_Image values (38, 169)
insert into Product_Image values (38, 170)
insert into Product_Image values (39, 171)
insert into Product_Image values (39, 172)
insert into Product_Image values (39, 173)
insert into Product_Image values (39, 174)
insert into Product_Image values (39, 175)
insert into Product_Image values (39, 176)
insert into Product_Image values (40, 177)
insert into Product_Image values (40, 178)
insert into Product_Image values (40, 179)
insert into Product_Image values (40, 180)
insert into Product_Image values (40, 181)
insert into Product_Image values (41, 182)
insert into Product_Image values (41, 183)
insert into Product_Image values (42, 184)
insert into Product_Image values (42, 185)
insert into Product_Image values (42, 186)
insert into Product_Image values (42, 187)
insert into Product_Image values (42, 188)
insert into Product_Image values (43, 189)
insert into Product_Image values (43, 190)
insert into Product_Image values (43, 191)
insert into Product_Image values (43, 192)
insert into Product_Image values (44, 193)
insert into Product_Image values (44, 194)
...
insert into Product_Image values (45, 200)
insert into Product_Image values (45, 201)
insert into Product_Image values (45, 202)
insert into Product_Image values (46, 203)
insert into Product_Image values (46, 204)
insert into Product_Image values (46, 205)
insert into Product_Image values (46, 206)
insert into Product_Image values (46, 207)
insert into Product_Image values (47, 208)
insert into Product_Image values (47, 209)
insert into Product_Image values (47, 210)
insert into Product_Image values (47, 211)
insert into Product_Image values (48, 212)
insert into Product_Image values (48, 213)
insert into Product_Image values (48, 214)
insert into Product_Image values (48, 215)
insert into Product_Image values (48, 216)
insert into Product_Image values (49, 217)
insert into Product_Image values (49, 218)
insert into Product_Image values (49, 219)
insert into Product_Image values (50, 220)
insert into Product_Image values (50, 221)
insert into Product_Image values (50, 222)
insert into Product_Image values (50, 223)
...
insert into Category values (11, 1, N'Áo chống nắng')
insert into Category values (12, 1, N'Áo len')
insert into Category values (13, 0, N'Đầm')
insert into Category values (14, 0, N'Đồ bộ')
insert into Category values (15, 0, N'Túi xách')
insert into Category values (16, 0, N'Ví')
insert into Category values (17, 0, N'Kính')
insert into Category values (18, 0, N'Quần')
insert into Category values (19, 18, N'Quần Nam')
insert into Category values (20, 18, N'Quần Nữ')
insert into Category values (21, 19, N'Quần Jean Nam')
insert into Category values (22, 19, N'Quần Âu Nam')
insert into Category values (23, 19, N'Quần Kaki Nam')
insert into Category values (24, 19, N'Quần Short Nam')
insert into Category values (25, 20, N'Quần Legging Nữ')
insert into Category values (26, 18, N'Quần Golf Nam')
...
insert into Product_Category values (34, 13)
insert into Product_Category values (35, 14)
insert into Product_Category values (36, 15)
insert into Product_Category values (37, 15)
insert into Product_Category values (38, 16)
insert into Product_Category values (39, 17)
insert into Product_Category values (40, 16)
insert into Product_Category values (41, 1)
insert into Product_Category values (42, 18)
insert into Product_Category values (43, 18)
insert into Product_Category values (44, 18)
insert into Product_Category values (45, 18)
insert into Product_Category values (46, 18)
insert into Product_Category values (47, 18)
insert into Product_Category values (48, 18)
insert into Product_Category values (49, 18)
insert into Product_Category values (50, 18)
