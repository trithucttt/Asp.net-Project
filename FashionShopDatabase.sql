...
'170000', 'RYU', 'Có sẵn')
insert into Products values(5, 1, 'Chân Váy Xếp Li ngắn MADELA Dáng Chữ A Lưng Cao 2 lớp dày dặn,váy tennis ngắn cạp cao siêu tôn dáng- VA01',
'MADELA cam kết với khách hàng về sản phẩm : Chân váy xếp ly - VA01. Sản phẩm thật cam kết 100% như mô tả. Tư vấn nhiệt tình, chu đáo luôn lắng nghe khách hàng. Giao hàng nhanh nhất có thể. Sản phẩm được kiểm tra kỹ càng, cẩn thận trước khi gói giao hàng cho Quý khách.',
'210000', 'MADELA', 'Có sẵn')
